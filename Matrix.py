...
class Matrix:
    def __init__(self, app1, font_size=8):
        self.image = None
        self.app = app1
        self.FONT_SIZE = font_size
        self.SIZE = self.ROWS, self.COLS = app1.HEIGHT // font_size, app1.WIDTH // font_size
        ...
        # self.image = self.get_image('img/Number1.png')

    def get_frame(self):
        ret, image = app.cam.read()
